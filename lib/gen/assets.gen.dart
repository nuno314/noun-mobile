...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/icon-foreground-1024x1024.png
  AssetGenImage get iconForeground1024x1024 =>
      const AssetGenImage('assets/images/icon-foreground-1024x1024.png');

  /// File path: assets/images/icon-round-1024x1024.png
  AssetGenImage get iconRound1024x1024 =>
      const AssetGenImage('assets/images/icon-round-1024x1024.png');

  /// List of all assets
  List<AssetGenImage> get values =>
      [icon1024x1024, iconForeground1024x1024, iconRound1024x1024];
}
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/ic_account_filled.svg
  SvgGenImage get icAccountFilled =>
      const SvgGenImage('assets/svg/ic_account_filled.svg');
  ...
  List<SvgGenImage> get values =>
      [icAccount, icAccountFilled, icHome, icHomeFilled, icPost];
}
